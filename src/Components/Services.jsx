    ...
    <div className='services-parent'>
      <div className='services-outer'>
        <div className='services-left'>
          <p className='fortyFive'>45+ Year Of Experience</p>
        ...
        <div className='services-right'>
         ...
         <div className="green-outer">
          ...
          <p className='green-bottom-para'>In more than 18 years of IT outsourcing. We have successfully delivered over 200 projects across 15 countries. </p>
          <p className='harry-waston'>Tayyab Sarfraz</p>
          <p className='abacus'>CEO, Sired Bit's</p>
         </div>
        </div>
      </div>
    </div>
